...
- Tell Me! / Erzähl mal v1 with parent/child Continue and model/expand language; no automatic pronunciation scoring. **Content foundation implemented:** typed manifest-only catalogue of 81 approved scenes / nine categories; UI/activity remains deferred. All 81 now have authored EN/DE runtime teaching/support data; German completion and the two Park counting source corrections are recorded in SceneDescriptions/GERMAN_REVIEW.md. Independent language acceptance and flagged visual-semantic ambiguities remain separate follow-up work. See CONTENT_DATA_SPEC.md and BUILD_NOTES.md.
