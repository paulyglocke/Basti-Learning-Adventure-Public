...
- Integrate native session restoration/lifecycle with the first migrated screen and build shared settings/completion UI components. Persistent progress/reward deduplication and physical recovery acceptance remain separate requirements; the framework does not complete those parts of this P1 item.
