...
internal enum class ShellScreen { HOME, OPTIONS, WEB, PREPOSITIONS, DAYS_SEASONS, SEASONS, WILMA, VOCABULARY, TELL_ME }
...
internal data class ShellNavigation(
    ...
    val backAction: BackAction get() = when (screen) {
        ...
        ShellScreen.PREPOSITIONS, ShellScreen.DAYS_SEASONS, ShellScreen.VOCABULARY, ShellScreen.TELL_ME -> BackAction.NATIVE_HOME
    ...
    fun openTellMe() = ShellNavigation(ShellScreen.TELL_ME)
