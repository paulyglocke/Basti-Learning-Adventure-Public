# Woodland / Forest — Wave 1

Status: COMPLETE and user-approved.

Approved production scenes:

1. `scene.woodland.features.01`
   - Primary: nouns + adjectives + visible features + comparisons
   - Asset: `canonical/woodland_001_features.png`

2. `scene.woodland.actions.02`
   - Primary: verbs + nouns
   - Asset: `canonical/woodland_002_actions.png`

3. `scene.woodland.positions.03`
   - Primary: spatial language
   - Asset: `canonical/woodland_003_positions.png`
